 ...
 * Definitely to fix:
 * - the $output_options argument in xmlrpc_encode_request() is partially supported
...
final class XmlRpc
{
     ...
     *                 Might, or not, implement options: output_type, verbosity
     */
    public static function xmlrpc_encode_request($method, $params, $output_options = array())
    {
        ...
        if (isset($output_options['escaping'])) {
            switch(true) {
                case is_array($output_options['escaping']) && in_array('markup', $output_options['escaping']):
