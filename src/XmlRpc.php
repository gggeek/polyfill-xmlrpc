...
final class XmlRpc
{
     ...
     */
    public static function xmlrpc_decode($xml, $encoding = '')
    {
     ...
     * @todo implement usage of $encoding
     */
    public static function xmlrpc_decode_request($xml, &$method, $encoding = '')
    {
        $val = php_xmlrpc_decode_xml($xml);
        if (!$val) {
            return null; // instead of false
     ...
     */
    public static function xmlrpc_encode_request($meth, $vals, $opts = null)
    {
     ...
     * @return string
     */
    public static function xmlrpc_get_type($val)
    {
     ...
     * @return boolean
     */
    public static function xmlrpc_is_fault($arr)
    {
     ...
     * @return string
     */
    public static function xmlrpc_server_call_method($server, $xml, $user_data, $output_options = null)
    {
